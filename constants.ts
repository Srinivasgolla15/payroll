...
export const PAYROLL_COLUMNS: { key: keyof PayrollData | 'placeholder' | 'ph' | 'bus' | 'food' | 'eb' | 'shoes' | 'kancha' | 'lastMonth' | 'totalPayment', label: string, editable?: boolean, isNumeric?: boolean }[] = [
    ...
    { key: 'kancha', label: 'Karcha', editable: true, isNumeric: true },
